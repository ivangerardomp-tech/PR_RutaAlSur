...
(function () {
  // Aquí defines qué archivo KML corresponde a qué TRAMO (como en PRs.csv)
  const KML_TRAMOS = [
    { id: "4503", url: "4503.kml" },
    { id: "4505", url: "4505.kml" },
    { id: "45HLB", url: "45HLB.kml" },
    { id: "45HLC", url: "ruta_densa_10m_45HLC.kml" }, // ruta densa a 10 m
  ];
  ...
  async function loadKmlForTramo(tramo) {
    try {
      ...
      // Tomamos el primer LineString (asumiendo uno por tramo)
  ...
  // Promesa global para que otros scripts sepan cuándo terminaron
